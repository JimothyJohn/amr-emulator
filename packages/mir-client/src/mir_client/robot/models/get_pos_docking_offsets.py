...
T = TypeVar("T", bound="GetPosDockingOffsets")


@_attrs_define
class GetPosDockingOffsets:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_pos_docking_offsets.additional_properties = d
        return get_pos_docking_offsets
