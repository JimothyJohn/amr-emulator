...
T = TypeVar("T", bound="GetSettingsAdvanced")


@_attrs_define
class GetSettingsAdvanced:
    """
    Attributes:
        default (str | Unset):
        id (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_settings_advanced.additional_properties = d
        return get_settings_advanced
