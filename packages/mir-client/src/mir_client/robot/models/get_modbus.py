...
class GetModbus:
    ...
    Attributes:
        ...
        registers (list[GetModbusRegistersItem] | Unset): The registers on the plc where the data will be stored
    ...
    registers: list[GetModbusRegistersItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _registers is not UNSET:
            ...
            for registers_item_data in _registers:
                registers_item = GetModbusRegistersItem.from_dict(registers_item_data)
        ...
        get_modbus.additional_properties = d
        return get_modbus
