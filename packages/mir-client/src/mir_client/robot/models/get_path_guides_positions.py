...
T = TypeVar("T", bound="GetPathGuidesPositions")


@_attrs_define
class GetPathGuidesPositions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_path_guides_positions.additional_properties = d
        return get_path_guides_positions
