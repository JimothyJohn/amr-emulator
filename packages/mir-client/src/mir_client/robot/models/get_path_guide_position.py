...
T = TypeVar("T", bound="GetPathGuidePosition")


@_attrs_define
class GetPathGuidePosition:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_path_guide_position.additional_properties = d
        return get_path_guide_position
