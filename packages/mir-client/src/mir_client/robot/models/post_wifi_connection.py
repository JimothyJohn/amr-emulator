...
if TYPE_CHECKING:
    from ..models.post_wifi_connection_scan_freqs_item import PostWifiConnectionScanFreqsItem


T = TypeVar("T", bound="PostWifiConnection")


@_attrs_define
class PostWifiConnection:
    """
    Attributes:
        ssid (str):
        address (str | Unset):
        ...
        gateway (str | Unset):
        netmask (str | Unset):
        scan_freqs (list[PostWifiConnectionScanFreqsItem] | Unset):
        security (str | Unset):
    """
    ...
    scan_freqs: list[PostWifiConnectionScanFreqsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.post_wifi_connection_scan_freqs_item import (
            PostWifiConnectionScanFreqsItem,  # noqa: PLC0415
        )
        ...
        if _scan_freqs is not UNSET:
            ...
            for scan_freqs_item_data in _scan_freqs:
                scan_freqs_item = PostWifiConnectionScanFreqsItem.from_dict(scan_freqs_item_data)

                scan_freqs.append(scan_freqs_item)

        security = d.pop("security", UNSET)

        post_wifi_connection = cls(
            ssid=ssid,
            address=address,
        ...
        post_wifi_connection.additional_properties = d
        return post_wifi_connection
