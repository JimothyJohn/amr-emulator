...
T = TypeVar("T", bound="GetHelperPositions")


@_attrs_define
class GetHelperPositions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_helper_positions.additional_properties = d
        return get_helper_positions
