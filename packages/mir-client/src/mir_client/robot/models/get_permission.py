...
T = TypeVar("T", bound="GetPermission")
...
class GetPermission:
    ...
    Attributes:
        ...
        user_group_guid (str | Unset): The global id of the usergroup
    """

    endpoint: str | Unset = UNSET
    guid: str | Unset = UNSET
    permission_type: str | Unset = UNSET
    user_group_guid: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if user_group_guid is not UNSET:
            field_dict["user_group_guid"] = user_group_guid
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_group_guid = d.pop("user_group_guid", UNSET)
        ...
        get_permission.additional_properties = d
