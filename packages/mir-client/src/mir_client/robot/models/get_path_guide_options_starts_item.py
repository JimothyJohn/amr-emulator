...
T = TypeVar("T", bound="GetPathGuideOptionsStartsItem")


@_attrs_define
class GetPathGuideOptionsStartsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_path_guide_options_starts_item = cls(
            name=name,
            pos_guid=pos_guid,
        )

        get_path_guide_options_starts_item.additional_properties = d
        return get_path_guide_options_starts_item
