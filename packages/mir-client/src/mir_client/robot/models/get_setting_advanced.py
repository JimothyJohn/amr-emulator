...
T = TypeVar("T", bound="GetSettingAdvanced")


@_attrs_define
class GetSettingAdvanced:
    """
    Attributes:
        children_ids (str | Unset):
        constraints (GetSettingAdvancedConstraints | Unset):
        default (str | Unset):
    ...
    constraints: GetSettingAdvancedConstraints | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_constraints, Unset):
            ...
            constraints = GetSettingAdvancedConstraints.from_dict(_constraints)
        ...
        get_setting_advanced.additional_properties = d
        return get_setting_advanced
