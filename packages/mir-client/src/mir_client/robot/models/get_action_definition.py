...
if TYPE_CHECKING:
    from ..models.get_action_definition_descriptions_item import GetActionDefinitionDescriptionsItem
    from ..models.get_action_definition_parameters_item import GetActionDefinitionParametersItem


T = TypeVar("T", bound="GetActionDefinition")


@_attrs_define
class GetActionDefinition:
    """
    Attributes:
        action_type (str | Unset):
        description (str | Unset):
        descriptions (list[GetActionDefinitionDescriptionsItem] | Unset):
        help_ (str | Unset):
        mission_group_id (str | Unset):
        name (str | Unset):
        parameters (list[GetActionDefinitionParametersItem] | Unset):
    """

    action_type: str | Unset = UNSET
    description: str | Unset = UNSET
    descriptions: list[GetActionDefinitionDescriptionsItem] | Unset = UNSET
    help_: str | Unset = UNSET
    mission_group_id: str | Unset = UNSET
    name: str | Unset = UNSET
    parameters: list[GetActionDefinitionParametersItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _descriptions is not UNSET:
            ...
            for descriptions_item_data in _descriptions:
                descriptions_item = GetActionDefinitionDescriptionsItem.from_dict(
        ...
        if _parameters is not UNSET:
            ...
            for parameters_item_data in _parameters:
                parameters_item = GetActionDefinitionParametersItem.from_dict(parameters_item_data)

                parameters.append(parameters_item)

        get_action_definition = cls(
        ...
        get_action_definition.additional_properties = d
