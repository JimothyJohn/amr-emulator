...
T = TypeVar("T", bound="GetCartCalibrations")


@_attrs_define
class GetCartCalibrations:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_cart_calibrations = cls(
            guid=guid,
            name=name,
            url=url,
        )

        get_cart_calibrations.additional_properties = d
        return get_cart_calibrations
