...
T = TypeVar("T", bound="GetPositionTransitionList")


@_attrs_define
class GetPositionTransitionList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_position_transition_list = cls(
        ...
        get_position_transition_list.additional_properties = d
        return get_position_transition_list
