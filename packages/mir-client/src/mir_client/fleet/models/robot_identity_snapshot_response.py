...
T = TypeVar("T", bound="RobotIdentitySnapshotResponse")


@_attrs_define
class RobotIdentitySnapshotResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        robot_identity_snapshot_response = cls(
            robot_identity_events=robot_identity_events,
        )

        return robot_identity_snapshot_response
